...
public class Gestionar_perfil extends JPanel {
	...
	public Gestionar_perfil() {
		...
		btnEditar.setIcon(new ImageIcon(Gestionar_perfil.class.getResource("/view/img/editarPerfil.PNG")));
		...
		btnBaja.setIcon(new ImageIcon(Gestionar_perfil.class.getResource("/view/img/darseBaja.PNG")));
		...
		btnEnviar.setIcon(new ImageIcon(Gestionar_perfil.class.getResource("/view/img/enviar.PNG")));
