...
public class TestingPersistentManager extends PersistentManager {
	...
	private TestingPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new TestingPersistentManager();
		}
