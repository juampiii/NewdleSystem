...
public class OpenDetachedCriteria extends AbstractORMDetachedCriteria {
	...
	public OpenDetachedCriteria() {
		super(model.Open.class, model.OpenCriteria.class);
	...
	public OpenDetachedCriteria(DetachedCriteria aDetachedCriteria) {
		super(aDetachedCriteria, model.OpenCriteria.class);
		ID = new IntegerExpression("ID", this.getDetachedCriteria());
		points = new DoubleExpression("points", this.getDetachedCriteria());
		text = new StringExpression("text", this.getDetachedCriteria());
		subevaluation_criteria = new StringExpression("subevaluation_criteria", this.getDetachedCriteria());
	...
	public Open uniqueOpen(PersistentSession session) {
		return (Open) super.createExecutableCriteria(session).uniqueResult();
	}
	
	public Open[] listOpen(PersistentSession session) {
